  ...
  return (
    <div className="min-h-screen bg-card">
      <div className="flex items-center gap-3 px-5 pt-4 pb-3 border-b border-divider">
        <button onClick={() => navigate(-1)} className="p-1.5 -ml-2 rounded-full hover:bg-muted transition-colors">
      ...
      <div className="px-5 pt-6 pb-16 max-w-sm mx-auto">
        ...
        <p className="text-body text-muted-foreground mt-2">Preencha seus dados para criar sua conta</p>
